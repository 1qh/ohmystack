...
- `backend/agent/convex/_generated/`
- `backend/agent/convex/convex.config.ts`
- `backend/agent/convex/schema.ts`
- `backend/agent/convex/auth.ts`
- `backend/agent/convex/auth.config.ts`
- `backend/agent/convex/testauth.ts`
- `backend/agent/convex/http.ts`
- `backend/agent/convex/crons.ts`
- `backend/agent/convex/sessions.ts`
...
- `backend/agent/convex/tokenUsage.ts`
- `backend/agent/convex/compaction.ts`
- `backend/agent/convex/rateLimit.ts`
- `backend/agent/convex/staleTaskCleanup.ts`
- `backend/agent/convex/retention.ts`
- `backend/agent/ai.ts`
- `backend/agent/env.ts`
- `backend/agent/lazy.ts`
- `backend/agent/prompts.ts`
- `backend/agent/t.ts`
- `backend/agent/models.mock.ts`
- `backend/agent/check-schema.ts`
...
1. Apply backend changes with `convex deploy` in `backend/agent`.
...
`backend/agent` runs in its own Convex project and deployment lifecycle, separate from `backend/convex`.
