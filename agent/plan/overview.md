...
A web-based agent harness inspired by oh-my-openagent (reference commit `5073efe`), implemented in the noboil monorepo with Convex, AI SDK v6, and Gemini 2.5 Flash. Runtime logic uses first-party tables and actions in `backend/agent`.
