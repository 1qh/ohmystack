  ...
  return (
    <main className='mx-auto flex h-screen w-full max-w-6xl flex-col gap-4 p-4 md:p-6'>
      ...
      <form className='flex shrink-0 gap-2' onSubmit={onSubmit}>
        <input
          className='flex-1 rounded-lg border bg-background px-3 py-2 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring'
          disabled={sending}
