...
| `noboil` | `sync` | Pull upstream template updates (coming soon) |
| `noboil` | `eject` | Inline library code, remove deps (coming soon) |
...
**Coming soon.** Pull upstream template updates into an existing project without overwriting local changes.

---

### eject

**Coming soon.** Inline all `@noboil/*` library code directly into your project and remove the package dependencies.
