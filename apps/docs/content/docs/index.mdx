...
| Native apps | Expo mobile + Swift codegen for iOS, Android, and macOS from the same schema |
...
| `noboil-convex` | Add tables, validate schema, migrate, visualize, generate Swift APIs, generate docs |
