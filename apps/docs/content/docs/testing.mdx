---
title: Testing
description: Unit tests, integration tests, and E2E testing for both Convex and SpacetimeDB backends.
---
...
Both databases support `expectedUpdatedAt` for optimistic concurrency control.
...
Both databases support E2E testing against the full stack.
