...
const testCreate = async (ctx: Ctx) => {
...
const testUpdate = async (ctx: Ctx, blogId: number) => {
...
const testForbidden = async (ctx: Ctx, blogId: number) => {
...
const testDelete = async (ctx: Ctx, blogId: number) => {
