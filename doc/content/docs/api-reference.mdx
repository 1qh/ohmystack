...
Coverage of public exports (every name reachable through `noboil/...` subpaths) by mention in `doc/content/docs/*.mdx`. **378/381 mentioned (99%).**

Undocumented (first 3 of 3):

`NoboilCondition`, `loadConfig`, `resolveAliasFor`
