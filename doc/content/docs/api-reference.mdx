...
Scanned **309 files**, **6997 declared symbols**. No `@beta`/`@alpha`/`@experimental`/`@deprecated`/`@internal` JSDoc tags found — entire public surface is **stable**.
...
**39 subpath exports** from `noboil` package.json. Use exact import paths for tree-shaking.
...
Coverage of public exports (every name reachable through `noboil/...` subpaths) by mention in `doc/content/docs/*.mdx`. **395/395 mentioned (100%).**
