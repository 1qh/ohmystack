...
| `@noboil/convex/schema`      | `child`, `cvFile`, `cvFiles`, `makeBase`, `makeOrgScoped`, `makeOwned`, `makeSingleton`, `orgSchema` |
| `@noboil/convex/zod`         | `unwrapZod`, `cvFileKindOf`, `cvMetaOf`, `defaultValue`, `defaultValues`, `elementOf`, `enumToOptions`, `isArrayType`, `isBooleanType`, `isDateType`, `isNumberType`, `isOptionalField`, `isStringType`, `pickValues`, `coerceOptionals`, `requiredPartial` |
...
| Module                               | Key Exports |
| ------------------------------------ | ----------- |
| `@noboil/spacetimedb`             | `guardApi`, `strictApi`, `zodFromTable`, `idToWire`, `idFromWire`, `identityToHex`, `identityFromHex`, `identityEquals` |
| `@noboil/spacetimedb/server`      | `noboilStdb`, `setup`, `setupCrud`, `makeCrud`, `makeSingletonCrud`, `makeCacheCrud`, `makeChildCrud`, `makeOrg`, `makeOrgTables`, `makeOrgCrud`, `checkMembership`, `canEdit`, `requireOrgMember`, `makePresence`, `presenceTable`, `makeFileUpload`, `makeSchema`, `zodToStdbFields`, `ownedTable`, `orgTable`, `orgChildTable`, `singletonTable`, `baseTable`, `childTable`, `rateLimitTable`, `uploadTables`, `orgTables`, `checkSchema`, `ownedCascade`, `orgCascade`, `err`, `errValidation`, `extractErrorData`, `fail`, `ok`, `time`, `getErrorCode`, `getErrorDetail`, `getErrorMessage`, `getFirstFieldError`, `getFieldErrors`, `handleError`, `isErrorCode`, `isMutationError`, `isRecord`, `matchError`, `makeUnique`, `checkRateLimit`, `warnLargeFilterSet`, `composeMiddleware`, `auditLog`, `inputSanitize`, `slowQueryWarn`, `createS3UploadPresignedUrl`, `createS3DownloadPresignedUrl`, `identityEquals`, `identityToHex`, `identityFromHex`, `idToWire`, `idFromWire`, `InferRow`, `InferCreate`, `InferUpdate`, `InferRows`, `InferReducerArgs`, `InferReducerReturn`, `TypedFieldErrors` |
| `@noboil/spacetimedb/react`       | `createOrgHooks`, `useForm`, `useFormMutation`, `useList`, `useOwnRows`, `useSearch`, `useInfiniteList`, `usePresence`, `useOptimisticMutation`, `useSoftDelete`, `useUpload`, `useBulkSelection`, `useBulkMutate`, `useCacheEntry`, `useMutate`, `useMutation`, `useMut`, `useOnlineStatus`, `useErrorToast`, `makeErrorHandler`, `OrgProvider`, `OptimisticProvider`, `useOrg`, `useActiveOrg`, `useMyOrgs`, `useOrgQuery`, `useOrgMutation`, `toastFieldError`, `defaultOnError`, `NoboilStdbDevtools`, `SchemaPlayground`, `buildMeta`, `getMeta`, `injectError`, `useDevErrors`, `usePendingMutations`, `canEditResource`, `setActiveOrgCookieClient`, `createFileUploader`, `createSpacetimeClient`, `createTokenStore`, `toWsUri`, `noop` |
...
| `@noboil/spacetimedb/schema`      | `schema`, `child`, `cvFile`, `cvFiles`, `makeOwned`, `makeOrgScoped`, `makeOrg`, `makeBase`, `makeSingleton`, `orgSchema` |
| `@noboil/spacetimedb/zod`         | `unwrapZod`, `cvFileKindOf`, `cvMetaOf`, `defaultValue`, `defaultValues`, `elementOf`, `enumToOptions`, `isArrayType`, `isBooleanType`, `isDateType`, `isNumberType`, `isOptionalField`, `isStringType`, `partialValues`, `pickValues`, `coerceOptionals`, `requiredPartial`, `schemaVariants` |
...
```typescript
import { noboilStdb, auditLog, inputSanitize, slowQueryWarn } from '@noboil/spacetimedb/server'

export default noboilStdb(
