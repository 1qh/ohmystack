...
|---|---|
| `log` | `append_{table}`, `bulk_append_{table}`, `purge_{table}_by_parent`, `restore_{table}_by_parent`, `rm_{table}`, `bulk_rm_{table}`, `update_{table}` |
| `kv` | `set_{table}`, `rm_{table}`, `restore_{table}` |
| `quota` | `consume_{table}`, `record_{table}` |
