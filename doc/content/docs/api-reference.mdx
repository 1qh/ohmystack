...
Scanned **347 files**, **7652 declared symbols**. No `@beta`/`@alpha`/`@experimental`/`@deprecated`/`@internal` JSDoc tags found — entire public surface is **stable**.
...
**41 subpath exports** from `noboil` package.json. Use exact import paths for tree-shaking.
...
Coverage of public exports (every name reachable through `noboil/...` subpaths) by mention in `doc/content/docs/*.mdx`. **476/476 mentioned (100%).**
