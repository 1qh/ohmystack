...
| ----------- | ------------------ | ------------------- | ---------------- | -------- | --------------- |
| `base`      | 247 / 173          | 92 / 86             | 17 / 17          | 236L     | 4 / 4 ✓         |
| `child`     | 266 / 164          | 36 / 36             | 11 / 13          | 240L     | 4 / 4 ✓         |
| `kv`        | 166 / 148          | 38 / 44             | 10 / 10          | 270L     | 4 / 4 ✓         |
| `log`       | 392 / 257          | 71 / 73             | 10 / 10          | 357L     | 5 / 5 ✓         |
| `orgScoped` | 488 / 402          | 36 / 36             | 35 / 33          | 255L     | 4 / 4 ✓         |
| `owned`     | 431 / 141          | 36 / 36             | 36 / 38          | 266L     | 5 / 5 ✓         |
| `quota`     | 112 / 110          | 31 / 78             | 9 / 9            | 257L     | 4 / 4 ✓         |
| `singleton` | 72 / 113           | 25 / 39             | 22 / 22          | 227L     | 4 / 4 ✓         |
...
| ------- | ----------------- | -------------------- | --------------------- | ------ |
| `blog`  | 8/8 ✓             | 52 / 52 ✓            | 871 / 944 ✓           | 🟢     |
| `chat`  | 5/5 ✓             | 26 / 26 ✓            | 491 / 417 ✓           | 🟢     |
| `movie` | 2/2 ✓             | 14 / 14 ✓            | 301 / 515 ✓           | 🟢     |
| `org`   | 18/18 ✓           | 128 / 128 ✓          | 2369 / 2633 ✓         | 🟢     |
| `poll`  | 6/7 ✓             | 82 / 82 ✓            | 840 / 883 ✓           | 🟢     |
...
| `file-field.tsx`       | ✓ 245L | ✓ 391L | 3              | —        | —         | 🟢     |
| `form.tsx`             | ✓ 170L | ✓ 197L | 6              | —        | —         | 🟢     |
| `index.ts`             | ✓ 11L  | ✓ 12L  | 20             | —        | —         | 🟢     |
| `misc.tsx`             | ✓ 11L  | ✓ 15L  | 3              | —        | —         | 🟢     |
...
**238 shared files · 43 cvx-only · 35 stdb-only · 0 files with cross-backend symbol divergence.** Status: 🟢 zero unaccounted-for gaps across the entire repo.

| Pair                     | shared    | cvx-only           | stdb-only          | symbol gaps | status |
| ------------------------ | --------: | ------------------ | ------------------ | ----------: | ------ |
| **lib/noboil/src**       | 78        | 4 (0 unaccounted)  | 22 (0 unaccounted) | 0           | 🟢     |
...
| **script (naming pair)** | 0 matched | 1 (0 unaccounted)  | 4 (0 unaccounted)  | —           | 🟢     |
