...
**238 shared files · 78 cvx-only · 35 stdb-only · 1 files with cross-backend symbol divergence.** Status: 🔴 36 unaccounted-for gap(s).

| Pair                     | shared    | cvx-only            | stdb-only          | symbol gaps | status |
| ------------------------ | --------: | ------------------- | ------------------ | ----------: | ------ |
| **lib/noboil/src**       | 78        | 39 (35 unaccounted) | 22 (0 unaccounted) | 1           | 🔴     |
