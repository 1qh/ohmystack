...
**526/528 blocks parseable (100%).** Snippets without TypeScript-shaped syntax (config JSON, shell, mermaid) are skipped — they're counted as parseable but not actually checked.
...
|---|---|---|---|---|---|
| `base` | 245 / 173 | 90 / 86 | 17 / 10 | 236L | 17 / 4 |
| `child` | 264 / 164 | 36 / 36 | 11 / 13 | 240L | 5 / 4 |
| `kv` | 164 / 148 | 38 / 44 | 2 / 1 | 180L | 84 / 9 |
| `log` | 390 / 257 | 71 / 73 | 2 / 2 | 221L | 151 / 9 |
| `orgScoped` | 486 / 400 | 36 / 36 | 35 / 20 | 255L | 22 / 4 |
| `owned` | 429 / 139 | 36 / 36 | 33 / 38 | 266L | 69 / 6 |
| `quota` | 110 / 110 | 31 / 78 | 9 / 2 | 187L | 89 / 9 |
| `singleton` | 70 / 113 | 25 / 39 | 22 / 11 | 227L | 14 / 14 |
