...
**472/472 blocks parseable (100%).** Snippets without TypeScript-shaped syntax (config JSON, shell, mermaid) are skipped — they're counted as parseable but not actually checked.
...
**0 duplicate paragraph(s) found** (across 28 doc files).
...
|---|---|---|---|---|---|
| `base` | 245 / 173 | 90 / 86 | 12 / 4 | — | 13 / 3 |
| `child` | 264 / 164 | 36 / 36 | 10 / 11 | — | 5 / 3 |
| `kv` | 164 / 148 | 38 / 44 | 1 / 1 | 180L | 78 / 9 |
| `log` | 390 / 257 | 71 / 73 | 7 / 2 | 221L | 148 / 9 |
| `orgScoped` | 486 / 400 | 36 / 36 | 26 / 1 | — | 22 / 3 |
| `owned` | 429 / 139 | 36 / 36 | 49 / 18 | — | 69 / 5 |
| `quota` | 110 / 110 | 31 / 78 | 1 / 2 | 187L | 89 / 9 |
| `singleton` | 70 / 113 | 25 / 39 | 13 / 8 | — | 14 / 8 |
