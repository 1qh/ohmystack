...
**238 shared files · 74 cvx-only · 35 stdb-only · 1 files with cross-backend symbol divergence.** Status: 🔴 32 unaccounted-for gap(s).

| Pair                     | shared    | cvx-only            | stdb-only          | symbol gaps | status |
| ------------------------ | --------: | ------------------- | ------------------ | ----------: | ------ |
| **lib/noboil/src**       | 78        | 35 (31 unaccounted) | 22 (0 unaccounted) | 1           | 🔴     |
...
- **lib/noboil/src**: cvx-only file `tools/caller-runtime.ts`, `tools/define-provider.ts`, `tools/prompt-blocks.ts`, `tools/http.ts`, `tools/validate.ts`, `tools/builder.ts`, `tools/parser.ts`, `tools/codegen/schema.ts`, `tools/codegen/emit.ts`, `tools/codegen/scan.ts`, `tools/codegen/extract-meta.ts`, `tools/codegen/index.ts`, `tools/types.ts`, `tools/__tests__/dispatch.test.ts`, `tools/__tests__/manifest.test.ts`, `tools/__tests__/parser.test.ts`, `tools/__tests__/boundary.test.ts`, `tools/__tests__/step-sink.test.ts`, `tools/__tests__/to-dispatch-error.test.ts`, `tools/__tests__/error.test.ts`, `tools/manifest.ts`, `tools/hermetic.ts`, `tools/index.ts`, `tools/error.ts`, `server/budget.ts`, `server/test-harness.ts`, `server/audit.ts`, `__tests__/budget.property.test.ts`, `__tests__/audit.test.ts`, `__tests__/budget.test.ts`, `__tests__/budget.synthetic.test.ts`
