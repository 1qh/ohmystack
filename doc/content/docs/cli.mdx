...
{/* AUTO-GENERATED:CLI-FLAGS:START */}
...
{/* AUTO-GENERATED:CONFIG-SCHEMA:START */}
**NoboilConfig**

| Field | Type |
|---|---|
| `fieldTypes?` | `Record&lt;string, CustomFieldType&gt;` |
| `hooks?` | `\{ afterAdd?: (ctx: AddContext) =&gt; Promise&lt;void&gt; \| void beforeAdd?: (ctx: AddContext) =&gt; Promise&lt;void&gt; \| void \}` |
...
| `description?` | `string` |
| `stdb` | `string` |
{/* AUTO-GENERATED:CONFIG-SCHEMA:END */}
