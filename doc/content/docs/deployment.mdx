...
This starts SpacetimeDB at `%%url:stdbWs%%` (WebSocket) and `http://localhost:%%port:stdb%%` (HTTP API). File uploads are stored inline as byte arrays.

Publish your module (replace `my-app` with your SpacetimeDB module name):

```bash
spacetime publish my-app --module-path %%path:backendStdb%%/
```
...
spacetime generate \
  --lang typescript \
  --module-path %%path:backendStdb%%/ \
  --out-dir %%path:backendStdb%%/module_bindings/
```
...
```bash
NEXT_PUBLIC_SPACETIMEDB_URI=%%url:stdbWs%%
...
spacetime publish my-app --server maincloud --module-path %%path:backendStdb%%/
```
...
spacetime publish my-app --server myserver --module-path %%path:backendStdb%%/
```
...
run: spacetime publish my-app --server maincloud --module-path %%path:backendStdb%%/
        env:
...
```bash
curl http://localhost:%%port:stdb%%/v1/ping
curl http://localhost:%%port:stdb%%/database/ping
```
...
**21 environment variables read** by `lib/noboil/src/` (excluding tests). Set these in your project's `.env` / runtime config.

| Var                                   | Files | Where                                                                                                                                                                                                                                                                                                                                                                            |
| ------------------------------------- | ----: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `CLI_SESSION_ID`                      | 1     | `lib/noboil/src/convex/tools/_bin/x.ts`                                                                                                                                                                                                                                                                                                                                          |
| `CLI_SESSION_SECRET`                  | 1     | `lib/noboil/src/convex/tools/_bin/x.ts`                                                                                                                                                                                                                                                                                                                                          |
| `CONVEX_SELF_HOSTED_ADMIN_KEY`        | 1     | `lib/noboil/src/convex/tools/_bin/x.ts`                                                                                                                                                                                                                                                                                                                                          |
| `CONVEX_SITE_URL`                     | 1     | `lib/noboil/src/convex/tools/_bin/x.ts`                                                                                                                                                                                                                                                                                                                                          |
| `CONVEX_TEST_MODE`                    | 2     | `lib/noboil/src/convex/next/active-org.ts`, `lib/noboil/src/convex/server/env.ts`                                                                                                                                                                                                                                                                                                |
| `CONVEX_URL`                          | 1     | `lib/noboil/src/convex/next/active-org.ts`                                                                                                                                                                                                                                                                                                                                       |
| `DOCS_OUT`                            | 1     | `lib/noboil/src/convex/tools/_bin/x-docgen.ts`                                                                                                                                                                                                                                                                                                                                   |
| `NEXT_PUBLIC_CONVEX_URL`              | 2     | `lib/noboil/src/convex/create.ts`, `lib/noboil/src/convex/next/active-org.ts`                                                                                                                                                                                                                                                                                                    |
| `NEXT_PUBLIC_PLAYWRIGHT`              | 2     | `lib/noboil/src/convex/next/active-org.ts`, `lib/noboil/src/spacetimedb/next/active-org.ts`                                                                                                                                                                                                                                                                                      |
...
| `PLAYWRIGHT`                          | 2     | `lib/noboil/src/convex/next/active-org.ts`, `lib/noboil/src/spacetimedb/next/active-org.ts`                                                                                                                                                                                                                                                                                      |
| `SPACETIMEDB_MODULE_NAME`             | 2     | `lib/noboil/src/spacetimedb/next/active-org.ts`, `lib/noboil/src/spacetimedb/server/test.ts`                                                                                                                                                                                                                                                                                     |
| `SPACETIMEDB_TEST_MODE`               | 2     | `lib/noboil/src/spacetimedb/next/active-org.ts`, `lib/noboil/src/spacetimedb/server/test.ts`                                                                                                                                                                                                                                                                                     |
...
| `TOOLS_ROOT`                          | 2     | `lib/noboil/src/convex/tools/_bin/x-codegen.ts`, `lib/noboil/src/convex/tools/_bin/x-docgen.ts`                                                                                                                                                                                                                                                                                  |
| `X_API_KEY`                           | 1     | `lib/noboil/src/convex/tools/_bin/x.ts`                                                                                                                                                                                                                                                                                                                                          |
