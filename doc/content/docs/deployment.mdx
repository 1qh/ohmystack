...
This starts SpacetimeDB at `ws://localhost:4000` (WebSocket) and `http://localhost:4000` (HTTP API). File uploads are stored inline — no separate object storage needed.
