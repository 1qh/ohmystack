...
|---|---|---|---|
| owned CRUD | `crud.ts` | ✓ (427 loc) | ✓ (139 loc) |
| org-scoped CRUD | `org-crud.ts` | ✓ (486 loc) | ✓ (400 loc) |
| child CRUD | `child.ts` | ✓ (263 loc) | ✓ (163 loc) |
| singleton (1-per-user) | `singleton.ts` | ✓ (70 loc) | ✓ (112 loc) |
| cache (TTL + refresh) | `cache-crud.ts` | ✓ (245 loc) | ✓ (172 loc) |
| log (append-only) | `log.ts` | ✓ (390 loc) | ✓ (256 loc) |
| kv (string-keyed) | `kv.ts` | ✓ (164 loc) | ✓ (147 loc) |
| quota (sliding window) | `quota.ts` | ✓ (110 loc) | ✓ (109 loc) |
| org schema (membership + invites) | `org.ts` | ✓ (299 loc) | ✓ (565 loc) |
| org members API | `org-members.ts` | ✓ (138 loc) | ✓ (244 loc) |
| org invites API | `org-invites.ts` | ✓ (107 loc) | ✓ (396 loc) |
| org join requests | `org-join.ts` | ✓ (142 loc) | ✓ (259 loc) |
| presence | `presence.ts` | ✓ (87 loc) | ✓ (141 loc) |
| file uploads | `file.ts` | ✓ (416 loc) | ✓ (146 loc) |
| middleware (audit, sanitize, slow-warn) | `middleware.ts` | ✓ (64 loc) | ✓ (70 loc) |
