...
|---|---|---|---|
| owned CRUD | `crud.ts` | ✓ (428 loc) | ✓ (140 loc) |
| org-scoped CRUD | `org-crud.ts` | ✓ (487 loc) | ✓ (401 loc) |
| child CRUD | `child.ts` | ✓ (264 loc) | ✓ (163 loc) |
| singleton (1-per-user) | `singleton.ts` | ✓ (71 loc) | ✓ (112 loc) |
| cache (TTL + refresh) | `cache-crud.ts` | ✓ (246 loc) | ✓ (172 loc) |
| log (append-only) | `log.ts` | ✓ (391 loc) | ✓ (256 loc) |
| kv (string-keyed) | `kv.ts` | ✓ (165 loc) | ✓ (147 loc) |
| quota (sliding window) | `quota.ts` | ✓ (111 loc) | ✓ (109 loc) |
| org schema (membership + invites) | `org.ts` | ✓ (300 loc) | ✓ (565 loc) |
| org members API | `org-members.ts` | ✓ (139 loc) | ✓ (244 loc) |
| org invites API | `org-invites.ts` | ✓ (108 loc) | ✓ (396 loc) |
| org join requests | `org-join.ts` | ✓ (143 loc) | ✓ (259 loc) |
| presence | `presence.ts` | ✓ (88 loc) | ✓ (141 loc) |
| file uploads | `file.ts` | ✓ (417 loc) | ✓ (146 loc) |
| middleware (audit, sanitize, slow-warn) | `middleware.ts` | ✓ (65 loc) | ✓ (71 loc) |
