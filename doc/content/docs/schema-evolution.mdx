...
1. Edit your module (`%%path:backendStdb%%/src/index.ts`)
2. Publish: `spacetime publish my-app --module-path %%path:backendStdb%%/`
3. Regenerate bindings: `spacetime generate --lang typescript --module-path %%path:backendStdb%%/ --out-dir %%path:backendStdb%%/module_bindings/`
...
```bash
spacetime generate --lang typescript --module-path %%path:backendStdb%%/ --out-dir %%path:backendStdb%%/module_bindings/
```
