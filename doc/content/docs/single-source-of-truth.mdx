...
noboil ships **17 generators** that own **14 marker blocks** across 5 doc files. Every block is rebuilt from source on `bun docs` and CI fails on drift via `bun docs:check`.
...
|---|---|
| `README.md` | `PACKAGE-INFO`, `DEMO-COUNT`, `CLI-TABLE-TYPES`, `DEMO-TREE` |
| `TODO.md` | `TEST-COUNTS` |
