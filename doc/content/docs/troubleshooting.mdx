...
| Docker Compose fails to start | Port conflicts on 4000 (SpacetimeDB) or 4600/4601 (MinIO) | Run `docker compose ps` to identify conflicts, then stop the conflicting service |
