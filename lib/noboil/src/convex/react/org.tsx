...
const useMyOrgs = <O extends OrgDoc>(myOrgsQuery: FunctionReference<'query'>) => {
...
const createOrgHooks = <F extends FunctionReference<'query'>, O extends OrgDoc = InferOrg<F>, M = unknown>(orgApi: {
  get: F
