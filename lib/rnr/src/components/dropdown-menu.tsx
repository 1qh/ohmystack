import { Icon } from '@a/rnr/components/icon'
import { NativeOnlyAnimatedView } from '@a/rnr/components/native-only-animated-view'
import { TextClassContext } from '@a/rnr/components/text'
      ...
      <DropdownMenuPrimitive.CheckboxItem
        ...
        <View className='absolute left-2 flex h-3.5 w-3.5 items-center justify-center'>
          <DropdownMenuPrimitive.ItemIndicator>
            <Icon as={Check} className={cn('text-foreground size-4', Platform.select({ web: 'pointer-events-none' }))} />
          </DropdownMenuPrimitive.ItemIndicator>
        </View>
        <>{children}</>
      </DropdownMenuPrimitive.CheckboxItem>
