...
const ConflictDialog = ({
  ...
  useWithGuard = <T extends GuardedFormState>(base: T): T & { guard: ReturnType<typeof useNavigationGuard> } => {
  ...
  hasFileFields = (meta: FileMeta): boolean => {
