...
const { deriveLabel, fields, FormContext, ServerFieldError } = createFieldsModule({
    ...
    errors: {
      ...
      unknownField: ({ available, name }) =>
        `[@noboil/spacetimedb] Unknown field: "${name}". Available fields: ${available}. Check your Zod schema — the field name must match a key in the schema passed to <Form>.`,
