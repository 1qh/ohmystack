...
const SidebarContext = React.createContext<null | SidebarContextProps>(null),
 ...
 SidebarProvider = ({
  ...
  // We use openProp and setOpenProp for control from outside the component.
   [_open, _setOpen] = React.useState(defaultOpen ?? false),
   open = openProp ?? _open,
  ...
  // Helper to toggle the sidebar.
   toggleSidebar = React.useCallback(() => isMobile ? setOpenMobile((open) => !open) : setOpen((open) => !open), [isMobile, setOpen, setOpenMobile])
 ...
 SidebarInset = ({ className, ...props }: React.ComponentProps<"main">) => (<main
      className={cn(
 ...
 SidebarInput = ({
  ...
  ...props
      ...
      {...props}
    />),
 SidebarHeader = ({ className, ...props }: React.ComponentProps<"div">) => (<div
      className={cn("flex flex-col gap-2 p-2", className)}
      data-sidebar="header"
      data-slot="sidebar-header"
      {...props}
    />),
 SidebarFooter = ({ className, ...props }: React.ComponentProps<"div">) => (<div
      className={cn("flex flex-col gap-2 p-2", className)}
      data-sidebar="footer"
 ...
 SidebarSeparator = ({
  className,
  ...props
}: React.ComponentProps<typeof Separator>) => (<Separator
      className={cn("mx-2 w-auto bg-sidebar-border", className)}
      data-sidebar="separator"
      data-slot="sidebar-separator"
      {...props}
    />),
 SidebarContent = ({ className, ...props }: React.ComponentProps<"div">) => (<div
      className={cn(
      ...
      {...props}
    />),
 SidebarGroup = ({ className, ...props }: React.ComponentProps<"div">) => (<div
 ...
 SidebarGroupContent = ({
  className,
  ...props
}: React.ComponentProps<"div">) => (<div
      className={cn("w-full text-sm", className)}
      data-sidebar="group-content"
      data-slot="sidebar-group-content"
      {...props}
    />),
 SidebarMenu = ({ className, ...props }: React.ComponentProps<"ul">) => (<ul
      className={cn("flex w-full min-w-0 flex-col gap-1", className)}
      data-sidebar="menu"
      data-slot="sidebar-menu"
      {...props}
    />),
 SidebarMenuItem = ({ className, ...props }: React.ComponentProps<"li">) => (<li
 ...
 SidebarMenuSub = ({ className, ...props }: React.ComponentProps<"ul">) => (<ul
      className={cn(
