...
const parseArgs = (): { convex: string; mobileOutput: string; output: string; schema: string } => {
    ...
    if (!(r.schema && r.convex && r.output)) {
       process.stderr.write(
         'Usage: ohmystack-convex codegen-swift --schema <path> --convex <path> --output <path> [--mobile-output <path>]\n'
       )
      process.exit(1)
    }
    return {
...
emit('// Auto-generated by @ohmystack/convex-codegen-swift. DO NOT EDIT.')
...
if (MOBILE_OUTPUT_PATH) {
  const mLines: string[] = [],
   ...
   me('// Auto-generated by @ohmystack/convex-codegen-swift. DO NOT EDIT.')
